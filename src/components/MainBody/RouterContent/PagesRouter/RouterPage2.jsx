...
import img3 from "./img/card.svg";
import img4 from "./img/card2.svg";
import { useNavigate } from 'react-router-dom';
import { useState} from 'react';
import "./routerPage1.index.css";


export default function RouterPage2 ({countChange, setCountChange}) {
    ...
    const handleButtonClick = () => {
        navigate('/page1');  // Переход на маршрут /
    };
    ...
    const counerImg = () => {
        ...
        setCountChange(checkedImages.length + countChange);
    };
        ...
        <>
         <div className="containerPageOne">
                ...
                <div className="containerPage1">
                    <h1>Какая планировка вам подходит?</h1>
